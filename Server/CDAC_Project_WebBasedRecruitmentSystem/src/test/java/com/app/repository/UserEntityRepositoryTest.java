...
class UserEntityRepositoryTest {
	...
	void testAddUsers1() {
		List<UserEntity> list = List.of(
				new UserEntity("Adnan", "Khan",Gender.MALE,"adnan@gmail.com","9876543210",enc.encode("12345"), UserRole.ROLE_ADMIN),
				new UserEntity("Mahendr", "Kumar",Gender.MALE,"mahender@gmail.com","9898747465",enc.encode("2345"), UserRole.ROLE_APPLICANT),
				new UserEntity("Arshad", "Mujawar",Gender.MALE,"arshad@gmail.com","9876543210",enc.encode("1345"), UserRole.ROLE_HR),
